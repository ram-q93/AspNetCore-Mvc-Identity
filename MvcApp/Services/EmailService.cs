...
namespace MvcApp.Services
{
    ...
    {
        private const string templatePath = @"Services/EmailTemplate/{0}.html";
        ...
        public async Task SendEmailForForgotPassword(AppUser user, string link)
        {
            UserEmailOptionsModel userEmailOptions = new UserEmailOptionsModel
            {
